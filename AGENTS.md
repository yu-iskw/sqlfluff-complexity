...
- **[`skills/`](skills/)** — User-installable agent skills for adopting CPX in **other** repositories (for example [`skills/configure-cpx/`](skills/configure-cpx/), [`skills/analyze-cpx-report/`](skills/analyze-cpx-report/)); copy or link into your tool’s skills directory
