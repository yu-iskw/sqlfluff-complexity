...
| **Claude Code**                                     | Reads [CLAUDE.md](CLAUDE.md) (which inlines this file) plus [`.claude/`](.claude/). [Claude Code: CLAUDE.md](https://code.claude.com/docs/en/claude-md), [Claude directory](https://code.claude.com/docs/en/claude-directory)                                                                                                                                                                                                                                                                       | <!-- markdown-link-check-disable-line --> |
...
- **[`plugins/sqlfluff-complexity/`](plugins/sqlfluff-complexity/)** — Distributable coding-agent plugin (Claude Code, Cursor, Codex) with end-user skills such as [`configure-sqlfluff-complexity`](plugins/sqlfluff-complexity/skills/configure-sqlfluff-complexity/SKILL.md); install via repo [`.claude-plugin/`](.claude-plugin/marketplace.json), [`.cursor-plugin/`](.cursor-plugin/marketplace.json), or [`.codex-plugin/`](.codex-plugin/marketplace.json) marketplaces (see [docs/adoption.md](docs/adoption.md#coding-agent-plugin))
