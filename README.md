...
CTE dependency depth, set operations (`UNION` / `INTERSECT` / `EXCEPT`), inline derived tables,
distinct source relations, wide `SELECT` lists, aggregation complexity, and
