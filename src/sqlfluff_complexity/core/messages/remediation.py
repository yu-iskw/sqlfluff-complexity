...
REMEDIATIONS: dict[str, str] = {
    "CPX_C101": ("Consider splitting long CTE chains into clearer transformation phases or upstream models."),
    "CPX_C102": (
        "Consider reducing join fan-in, moving enrichment upstream, or validating whether all joined "
        "relations are needed."
    ),
    "CPX_C103": ("Consider replacing deeply nested subqueries with named CTEs or intermediate transformations."),
    "CPX_C104": (
        "Consider moving dense CASE business logic into reference tables, seed data, or upstream transformations."
    ),
    "CPX_C105": ("Consider decomposing complex predicates into named boolean flags or smaller filtering steps."),
    "CPX_C106": (
        "Consider splitting analytic/window logic into clearer phases or deduplicating repeated window specifications."
    ),
    "CPX_C107": ("Consider splitting the query into simpler intermediate models or reducing chained CTEs."),
    "CPX_C108": (
