...
from sqlfluff_complexity.rules.base import MetricRuleSpec, metric_lint_result, resolve_context_policy
...
class Rule_CPX_C101(BaseRule):  # noqa: N801
    ...
    _spec: ClassVar[MetricRuleSpec] = metric_rule_spec("CPX_C101")
